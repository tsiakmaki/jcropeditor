...
/**
 * ConceptGraphConnectionHandler overrides some functions 
 ...
 */
public class ConceptGraphConnectionHandler extends mxConnectionHandler  {
	
	public ConceptGraphConnectionHandler(mxGraphComponent graphComponent) {
