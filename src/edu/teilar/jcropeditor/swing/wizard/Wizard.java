...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    protected JDialog wizardDialog;
    ...
    public Wizard(Frame owner) {
        ...
        Point newLocation = new Point(middle.x - 300, middle.y - 150);
        wizardDialog.setLocation(newLocation);
    }
   ...
   /**
    ...
    private void initComponents() {
        ...
        wizardDialog.getContentPane().add(getButtonPanel(), java.awt.BorderLayout.SOUTH);
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("edu.teilar.jcropeditor.core.wizard.Wizard");
