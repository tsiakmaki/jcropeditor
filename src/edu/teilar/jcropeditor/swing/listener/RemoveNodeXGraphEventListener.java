 ...
 */
public class RemoveNodeXGraphEventListener implements mxIEventListener {

	private static final Logger logger = Logger
			.getLogger(RemoveNodeXGraphEventListener.class);
	...
	public void invoke(Object sender, mxEventObject evt) {
		...
		// x graph node that removed label
		String removedNodeLabel = (String) evt.getProperty("removedNodeLabel");

		// it is a vertex
		logger.info("Delete x graph node from the onotology: "
				+ removedNodeLabel);
		*/
	}
