 ...
 */
public class KRCEdgeRemovedKRCEventListener implements mxIEventListener {

	private static final Logger logger = Logger
			.getLogger(KRCEdgeRemovedKRCEventListener.class);
	...
	public void invoke(Object sender, mxEventObject evt) {
		...
		ontoSync.syncAfterEdgeDeleteFromKRC((String) source.getValue(),
				(String) target.getValue(), activeKobj.getName());

		logger.info("[Deleted] edge from : " + source.getValue() + " to "
				+ target.getValue());
